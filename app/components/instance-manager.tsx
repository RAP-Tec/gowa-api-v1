          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Inclua o código do país e DDD, sem espaços ou caracteres especiais.</br>* Números de WhatsApp com DDD superior a 30 podem não ter número 9 no início, exemplo: SP: 5511987654321 | BH: 553187654321
              </p>
            </div>
          </CardContent>
          <CardFooter>
